...
def order_pdf(obj):
    return mark_safe('<a href={}>Download PDF</a>' \
        .format(reverse('admin_order_pdf', args=[obj.id])))

order_pdf.short_description = 'Receipt'

# TODO: ADD FUNCTIONS FOR ARRIVED AND ORDERED
